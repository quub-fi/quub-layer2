...
async function main() {
  ...
  const ethConfig: ChainConfig = {
    ...
    settlementContract: process.env.ETH_SETTLEMENT_CONTRACT || '0x0000000000000000000000000000000000000000',
    bridgeContract: process.env.ETH_BRIDGE_CONTRACT || '0x0000000000000000000000000000000000000000',
    gasLimit: 500000,
  ...
  const bscConfig: ChainConfig = {
    ...
    settlementContract: process.env.BSC_SETTLEMENT_CONTRACT || '0x0000000000000000000000000000000000000000',
    bridgeContract: process.env.BSC_BRIDGE_CONTRACT || '0x0000000000000000000000000000000000000000',
    gasLimit: 500000,
  ...
  const polygonConfig: ChainConfig = {
    ...
    settlementContract: process.env.POLYGON_SETTLEMENT_CONTRACT || '0x0000000000000000000000000000000000000000',
    bridgeContract: process.env.POLYGON_BRIDGE_CONTRACT || '0x0000000000000000000000000000000000000000',
    gasLimit: 500000,
    requiredConfirmations: 1,
  };
